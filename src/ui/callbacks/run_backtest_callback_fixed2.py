...
def register_run_backtest_callback(app: Dash):
    ...
    @app.callback(
        ...
        Output(SharedComponentIDs.RUN_BACKTEST_TRIGGER_STORE, "data", allow_duplicate=True),
        # Output for error message when steps aren't completed
        Output(WizardIDs.RUN_BACKTEST_ERROR_MESSAGE, "children", allow_duplicate=True),
        Output(WizardIDs.RUN_BACKTEST_ERROR_MESSAGE, "style", allow_duplicate=True),
        ...
        # Prevent initial call as required when using allow_duplicate
