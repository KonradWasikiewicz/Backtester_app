...
def get_strategy_dropdown(available_strategies: List[Dict[str, str]]) -> dcc.Dropdown:
    """
    ...
    try:
        ...
        steps = [
            create_wizard_step(
                ...
                html.Div([
                    ...
                    dbc.Input(
                        ...
                        type='text',  
                        value="100 000",  
                        className="mb-1 numeric-input-formatted", 
                    ),
                    dbc.FormFeedback(
                    ...
                    dbc.FormFeedback(
                        id=WizardIDs.STRATEGY_DROPDOWN_FEEDBACK,
                        type="invalid",
                        className="mb-3"
                    ),
            ...
            create_wizard_step(
                ...
                html.Div([
                    html.Label("Select tickers to trade:", className="mb-2", htmlFor=WizardIDs.TICKER_DROPDOWN), 
                    html.Div([
                    ...
                    html.Div(id=WizardIDs.TICKER_LIST_CONTAINER, className="mt-2"),
                    dbc.Button(
                        "Confirm",
